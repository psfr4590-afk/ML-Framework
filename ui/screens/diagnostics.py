...
class DiagnosticsScreen(tk.Frame):
 ...
 def refresh(self):
  ...
  root=Path(__file__).resolve().parents[2]; checks=["README.md","docs/development/PROJECT_STATE.md","launch.py","run_pipeline.py","run_command_center.py","ui","config","scripts","pipeline","command_center","command_center/web.py",".runtime/environment.json"]
  for x in checks:
